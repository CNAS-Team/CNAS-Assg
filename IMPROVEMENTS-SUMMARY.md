...
- versioned database migrations, persistent MySQL, shared Redis sessions, and logical backup via scheduled CronJob;
...
- Prometheus, Grafana, Alertmanager, Loki, Alloy, blackbox probes, Kong/KIC metrics, MySQL and Redis exporters, and node monitoring;
